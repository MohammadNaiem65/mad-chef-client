    ...
    return (
        <section className='w-full'>
            ...
            <nav className='md:text-lg flex items-center divide-x-2 overflow-x-scroll xl:overflow-auto'>
                <Link
                    to='/profile/student/dashboard/bookmarks'
                ...
                <Link
                    to='/profile/student/dashboard/likes'
                ...
                <Link
                    to='/profile/student/dashboard/recipe-ratings'
                ...
                <Link
                    to='/profile/student/dashboard/chef-reviews'
                    className={`md:w-52 px-5 py-2 flex items-center gap-x-3 hover:bg-Primary/10 ${
