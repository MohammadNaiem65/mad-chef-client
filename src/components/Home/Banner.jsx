...
export default function Banner() {
	return (
		<section className='container gradient-bg w-full h-96 my-10 flex justify-center md:justify-evenly rounded shadow-lg overflow-hidden relative z-10'>
			...
			<div className='shape-bg-two h-32 aspect-square bg-Primary bg-opacity-10 hidden absolute left-32 -top-12 rotate-45' />
			<div className='shape-bg-two h-32 aspect-square bg-Primary bg-opacity-10 hidden absolute left-32 -top-10 rotate-45' />

			{/* Left Container */}
			<div className=' w-1/2flex justify-center items-center relative'>
				{/* Center blobs */}
				<div className='h-64 hidden md:block aspect-square shape-bg-one bg-Primary bg-opacity-20 absolute top-24 left-1/2 rotate-45' />
				<div className='h-64 hidden md:block aspect-square shape-bg-one bg-Primary bg-opacity-20 absolute top-24 left-1/2 rotate-[35deg]' />
			...
			{/* Right side blobs */}
			<div className='h-32 aspect-square shape-bg-two bg-Primary bg-opacity-10 absolute right-0 md:right-80 -bottom-10 rotate-45' />
